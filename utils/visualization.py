...
def extract_mesh(dim, chunk, scene_radius,
                 scene_origin, origin=None, radius=1.0,
                 with_color=False, embedding_a=None, 
                 chunk_rgb=256, sparse_data=None, renderer=None):
    if origin is None:
        origin = [0, 0, 0]
