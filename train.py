...
def main(hparams, config):
    ...
    checkpoint_callback = ModelCheckpoint(dirpath=f'{config.TRAINER.SAVE_DIR}/{hparams.exp_name}',
                                          filename='{epoch:d}',
    ...
    trainer = Trainer(max_epochs=hparams.num_epochs,
                      ...
                      resume_from_checkpoint=None, #checkpoints/brandenburg_scale1/epoch=0.ckpt
                      logger=logger,
